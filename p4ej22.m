...
s.move(Arecogida,1);
s.move(Allegada,1);
pieza2soltada= s.changePosXYZ(Allegada,[Allegada.xyz(1)-50 Allegada.xyz(2)+500 Allegada.xyz(3)]);
...
s.move(giro90,1);
pieza3recogida=s.changePosXYZ(giro90,[giro90.xyz(1)+250 giro90.xyz(2)+800 giro90.xyz(3)]);
...
s.move(Arecogida,1);
s.move(Allegada,1);
giro90s=s.changePosRoll(Allegada,900);
s.move(giro90s,1);
pieza3soltada=s.changePosXYZ(giro90s,[giro90s.xyz(1) giro90s.xyz(2)+400 giro90s.xyz(3)-800]);
...
%pieza 4
s.move(Arecogida,1);
aa= s.changePosXYZ(recogida,[recogida.xyz(1)+1300 recogida.xyz(2)-350 recogida.xyz(3)]);
s.move(aa,1);
giro30=s.changePosRoll(aa,-200);
s.move(giro30,1);
s.changeGripper(1);  % Abre la pinza
pieza4cogida= s.changePosXYZ(giro30,[giro30.xyz(1) giro30.xyz(2) giro30.xyz(3)-500]);
s.move(pieza4cogida,1);
s.changeGripper(0);  % Cierra la pinza
s.move(Arecogida,1);
s.move(Allegada,1);
pieza4soltada= s.changePosXYZ(Allegada,[Allegada.xyz(1)+500 Allegada.xyz(2) Allegada.xyz(3)]);
s.move(pieza4soltada,1);
s.changeGripper(1);  % Abre la pinza
s.move(Allegada,1);
s.changeGripper(0);
%pieza5
s.move(Arecogida,1);
aa= s.changePosXYZ(recogida,[recogida.xyz(1)+1300 recogida.xyz(2) recogida.xyz(3)]);
s.move(aa,1);
giro30=s.changePosRoll(aa,-200);
s.move(giro30,1);
s.changeGripper(1);  % Abre la pinza
pieza5cogida= s.changePosXYZ(giro30,[giro30.xyz(1) giro30.xyz(2) giro30.xyz(3)-500]);
s.move(pieza5cogida,1);
s.changeGripper(0);  % Cierra la pinza
s.move(Arecogida,1);
s.move(Allegada,1);
dejar4=[llegada.xyz(1)+500 llegada.xyz(2)+450 llegada.xyz(3)-500];
pieza5soltada= s.changePosXYZ(Allegada,[dejar4(1) dejar4(2) dejar4(3)]);
s.move(pieza5soltada,1);
s.changeGripper(1);  % Abre la pinza
s.move(Allegada,1);
s.changeGripper(0);